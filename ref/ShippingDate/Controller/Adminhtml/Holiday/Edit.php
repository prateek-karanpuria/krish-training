...
class Edit extends \Ktpl\ShippingDate\Controller\Adminhtml\Holiday
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('ktpl_shippingdate_holiday', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Holiday %1', $model->getId()) : __('New Holiday'));
        return $resultPage;
    }
}
