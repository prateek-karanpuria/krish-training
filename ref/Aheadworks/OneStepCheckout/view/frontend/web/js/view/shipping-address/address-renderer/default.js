    ...
    return Component.extend({
        ...
        initObservable: function () {
            ...
            this.isSelected = ko.computed(function() {
                ...
                selectedshippingmethodonject = {firstname:'',
                secondname:'',
                telephone:'',
                street1:'',
                street2:'',
                ...
                if (shippingAddress) {
                    ...
                    // selectedshippingmethodonject.firstname = this.address().firstname;
                    // selectedshippingmethodonject.secondname = this.address().lastname;
                    // selectedshippingmethodonject.telephone = this.address().telephone;
                    // selectedshippingmethodonject.street1 = this.address().street;
                    // selectedshippingmethodonject.street2 = '';
                    // selectedshippingmethodonject.country = this.address().countryId;
                    // selectedshippingmethodonject.state = this.address().region;
                }
