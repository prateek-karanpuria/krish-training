...
use Krish\Sample\Api\Data\SampleSearchResultInterfaceFactory;
...
use Krish\Sample\Traits\RepositorySearchResultBuilderTrait;
...
class SampleRepository implements SampleRepositoryInterface
{
     ...
     */
    public function getById($id): \Krish\Sample\Api\Data\SampleInterface
    {
        /** @var Sample $sampleModel */
        $sampleModel = $this->sampleFactory->create();
