...
return [
    'modules' => [
        ...
        'Klarna_Kp' => 0,
        'Krish_Sample' => 0,
        'Ktpl_CatalogSearchProductSortAsc' => 0,
        'Ktpl_CityDropdown' => 0,
        'Ktpl_MultiFlatRates' => 0,
        'Ktpl_Newsletter' => 0,
        'Ktpl_Signature' => 0,
        'Ktpl_Skydailywebshipments' => 0,
        'Ktpl_SpranksConfigurableTierPrices' => 0,
        'Ktpl_WageNewsletter' => 0,
        'Ktpl_WageWysiwyg' => 0,
        'Magento_PaypalReCaptcha' => 1,
        'MSP_TwoFactorAuth' => 1,
        'Mageplaza_Core' => 1,
        'Mageplaza_Multiflatrates' => 0,
        'Mageplaza_Smtp' => 1,
        'Mastering_Sample' => 0,
        'OrangeCompany_RoutingExample' => 0,
        'PHPCuong_Newsletter' => 0,
        'Practice_Test' => 0,
        'SussexDev_Sample' => 0,
        'Temando_Shipping' => 0,
        'Training_AdminLoginLogs' => 0,
        'Training_CustomProductContentTab' => 0,
        'Training_CustomerNickName' => 0,
        'Training_FeaturedProduct' => 0,
        'Training_OrderDeliveryDate' => 0,
        'Training_Testimonial' => 0,
        'Vertex_Tax' => 0
    ]
];
